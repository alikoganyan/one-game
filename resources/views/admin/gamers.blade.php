    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            <tr class="search-row">
                <form action='/adminsearch' method='post'>
                    {{ csrf_field() }}
                <td><input type='text' name='searchid' class='form-control search-field' data-name="id" placeholder="Search.."></td>
                <td><input type='text' name='searchname' class='form-control search-field' data-name="name" placeholder="Search.."></td>
                <td><input type='text' name='searchemail' class='form-control search-field' data-name="email" placeholder="Search.."></td>
                <td></td>
                <td></td>
                    <td></td>
                    <td></td>
        ...
        @foreach($gamers as $gamer)
            <form action="/adminupdategamer" method="post">
                {{ csrf_field() }}
            <tr data-key="1">
                <td data-name="id" data-value="{{$gamer->id}}">{{$gamer->id}}</td>
                <td data-name="name" data-value="{{$gamer->name}}"><input type="text" name="name" class="form-control" value="{{$gamer->name}}"></td>
